...
const committerMnemonic = generateMnemonic();
const committeeMnemonic = generateMnemonic();
...
const committerXpub = committerNode.neutered().toBase58();
const committeeXpub = committeeNode.neutered().toBase58();
